...
import macrocore.ChaosOrAlchMapRerollProvider
import macrocore.ChaosRerollProvider
import macrocore.CheckResult
import macrocore.CraftRerollProvider
import macrocore.CurrencySlots
import macrocore.ItemChecker
import macrocore.MapScorer
import macrocore.MapScorerImpl
import macrocore.MapScorerOutput
import macrocore.PoeItemParser
import macrocore.PoeRollableItem
import macrocore.PoeScreenConstants
import macrocore.ScreenPoint
import macrocore.ScourAlchRerollProvider
import macrocore.asItemChecker
import macrocore.fmt
import macrocore.generateMapReport
import macrocore.postAsciiString
import macrocore.postPressRelease
...
suspend fun townHotkeyMacro(
    ...
    val windowFlow = component.activeWindowChecker().activeWindowFlow(windowTitle)
        .stateIn(CoroutineScope(currentCoroutineContext()))
...
private suspend fun doSortInStash(
    interactor: macrocore.PoeInteractor,
    scorer: MapScorer,
