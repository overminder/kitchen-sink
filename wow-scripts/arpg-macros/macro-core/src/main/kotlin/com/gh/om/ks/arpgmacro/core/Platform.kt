...
fun ConsoleOutput.println(text: String) {
    print("${text}\n")
}
...
interface ActiveWindowChecker {
    fun isActiveWindow(anyTitles: Collection<String>): Boolean
}

fun ActiveWindowChecker.isActiveWindow(title: String): Boolean {
    return isActiveWindow(listOf(title))
}
